import errorIcon from "../../statics/error-icon.svg";
import infoIcon from "../../statics/info-icon.svg";
import successIcon from "../../statics/success-icon.svg";
import warningIcon from "../../statics/warning-icon.svg";
